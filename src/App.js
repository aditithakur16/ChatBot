...
function App() {
  ...
  const checkStatus = (e) => {
    let isActive = true;
    if (dateTime === "Wednesday, May 31 2023") {
      //if the dateTime is Wednesday, May 31 2023, the bot will be inactive
      isActive = false;
    }
  ...
  const handleInput = () => {
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Aditi Thakur";
        inputRef.value = ""; // clear the input
      }, 2000);
    }

    let owner2 = [
      "Who's Aditi|who's Aditi Thakur|Who is Aditi|who is Aditi Thakur",
    ];
    ...
    if (words10.test(document.querySelector("#input").value)) {
      ...
      setTimeout(() => {
        getBotMessage.innerText =
          "Aditi Thakur is a programmer. She is a Frontend Developer";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    ...
    if (words11.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "I am newBorn";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
